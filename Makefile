...
$(OMP_V4):
	$(CC) $(MAXITERS) $(CFLAGS) $(OMPFLAGS) $(SRC_DIR)/final/omp-k-means-v4.c -o $@ 
$(OMP_O3_V4):
	$(CC) $(MAXITERS) $(CFLAGS) $(O3) $(OMPFLAGS) $(SRC_DIR)/final/omp-k-means-v4.c -o $@ 

# Source is .cu (nvcc requires CUDA source extension).
# $(CUDA):
# 	$(NVCC) $(MAXITERS) $(CUDAFLAGS) $(SRC_DIR)/cuda-k-means.cu -o $@ 
$(CUDA_V2):
	$(NVCC) $(MAXITERS) $(CUDAFLAGS) $(SRC_DIR)/final/cuda-k-means-v2.cu -o $@ 
# $(CUDA_V3):
